"""Processing manifest schema — JSON Schema generation and validation."""
...
from acessilia_extractor.manifest.models import ProcessingManifest


def processing_manifest_schema() -> dict[str, Any]:
    """Gera o JSON Schema Draft 2020-12 a partir do modelo Pydantic."""
...
def write_processing_manifest_schema(destination: Path) -> Path:
    """Escreve o JSON Schema em um arquivo."""
